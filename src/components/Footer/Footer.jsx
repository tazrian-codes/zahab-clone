...
const Footer = () => {
  // State to control accordion sections in small screens
    ...
    <div className="footer">
      ...
      <div className="footer-top">
        <div className="footer-top-one">
          <p>
            Shop no 7, Block C, Level - 1, Bashundhara City Shopping Complex
            Dhaka, Bangladesh
          </p>
          <div className="footer-email">
            <span>Email:</span>
            <a href="mailto:contact@zahabperfumes.com">
              contact@zahabperfumes.com
            </a>
          </div>
      ...
      <div className="footer-top-sm-screen">
        ...
        <div className="categories-div">
          <div
            className="div-top categories"
            onClick={() => setCategoryOpen(!categoryOpen)}
          >
            <h4>Categories</h4>
            <img
              src="/src/assets/resources/down-arrow.png"
