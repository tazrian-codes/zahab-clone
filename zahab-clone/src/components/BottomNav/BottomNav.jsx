...
const BottomNav = () => {
  ...
  return (
    <div className="bottom-nav">
      <div
        className={`bottom-home bottom-div ${activeBtn === "/" ? "nav-border" : ""}`}
        onClick={() => navigate("/")}
      >
      ...
      <div
        className={`bottom-shop bottom-div ${activeBtn === "/shop" ? "nav-border" : ""}`}
      ...
      <div
        className={`bottom-cart bottom-div ${activeBtn === "/cart" ? "nav-border" : ""}`}
      ...
      <div
        className={`bottom-account bottom-div ${activeBtn === "/account" ? "nav-border" : ""}`}
